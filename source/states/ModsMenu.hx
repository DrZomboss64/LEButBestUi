...
class ModsMenu extends MusicBeatState
{
	...
	var side:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('Theme/Mods/Cont_side'));
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('Theme/Mods/Cont_Checker'), 0.2, 0.2, true, true);
